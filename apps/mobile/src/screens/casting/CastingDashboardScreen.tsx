        ...
        ListEmptyComponent={
          <View style={styles.emptyWrap}>
            ...
            <Text style={styles.emptyDesc}>
              Post your first casting call to find talent.
            </Text>
          </View>
        }
        renderItem={({ item }) => (
          <View style={styles.card}>
            <View style={styles.cardTop}>
              ...
              <View
                style={[
                  ...
                  {
                    backgroundColor:
                      item.status === 'open' ? '#dcfce7' : '#f3f4f6',
                  },
                ]}
              >
                <Text
                  style={{
                    fontSize: 11,
                    color:
                      item.status === 'open' ? '#16a34a' : colors.gray[500],
                    fontWeight: '500',
                  }}
                >
                  {item.status}
            ...
            {item.roleType && (
              <Text style={styles.roleType}>{item.roleType}</Text>
            )}
        ...
        <ScrollView style={styles.modal} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.modalBody}>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                if (!newCall.title || !newCall.description)
                  return Alert.alert(
                    'Error',
